...
-- Se crea el esquema "App" si no existe y se utiliza como esquema predeterminado.
...
INSERT INTO `App`.`event` (`img_url`, `title`, `event_date`, `des`, `created_by`) VALUES
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063539/Concierto_en_el_parque_bsrb0q.jpg', 'Concierto en el parque', '2024-05-10', 'Disfruta de un concierto al aire libre en el parque central', 1),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063635/Exposici%C3%B3n_de_arte_moderno_tb3ws6.jpg', 'Exposición de arte moderno', '2024-05-15', 'Ven a explorar las obras de artistas contemporáneos en nuestra galería', 2),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063711/Feria_gastron%C3%B3mica_internacional_rpfoob.jpg', 'Feria gastronómica internacional', '2024-05-20', 'Prueba delicias culinarias de todo el mundo en nuestra feria gastronómica', 3),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714062742/Competencia_de_surf_ehrdzl.jpghttps://example.com/event4.jpg', 'Competencia de surf', '2024-05-25', 'Únete a la emoción de nuestra competencia anual de surf', 4),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063577/Curso_de_cocina_italiana_ry32q9.jpg', 'Curso de cocina italiana', '2024-06-01', 'Aprende a preparar auténticos platos italianos con nuestros chefs expertos', 5),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063882/Torneo_de_ajedrez_tmudob.jpg', 'Torneo de ajedrez', '2024-06-05', 'Demuestra tus habilidades en nuestro torneo de ajedrez de nivel nacional', 6),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063751/Festival_de_danza_folcl%C3%B3rica_hoka24.jpg', 'Festival de danza folclórica', '2024-06-10', 'Disfruta de las coloridas y vibrantes actuaciones de danza folclórica de todo el mundo', 7),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063849/Taller_de_fotograf%C3%ADa_de_paisajes_txyfhf.jpg', 'Taller de fotografía de paisajes', '2024-06-15', 'Aprende técnicas avanzadas de fotografía de paisajes con nuestro taller intensivo', 8),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063773/Presentaci%C3%B3n_de_pel%C3%ADculas_independientes_hu8qrs.jpg', 'Presentación de películas independientes', '2024-06-20', 'Descubre nuevas y emocionantes películas independientes en nuestra muestra anual', 9),
('https://res.cloudinary.com/dicgppon6/image/upload/v1714063465/Conferencia_sobre_inteligencia_artificial_ou1z7u.jpg', 'Conferencia sobre inteligencia artificial', '2024-06-25', 'Explora el futuro de la inteligencia artificial en nuestra conferencia internacional', 10);
...
CREATE TABLE IF NOT EXISTS `App`.`language` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_language_event1_idx` (`event_id` ASC) VISIBLE,
  CONSTRAINT `fk_language_event1`
...
INSERT INTO `language` (`language`, `event_id`) VALUES
('Spanish', 1),
('English', 2),
('French', 3),
('German', 4),
